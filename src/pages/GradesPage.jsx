...
import { addGrade, updateGrade, deleteGrade, selectAllGrades } from "../features/grades/gradesSlice";
    ...
    <div className="fade-in">
      <div className="form-card">
        ...
        <form className="input-group" onSubmit={handleAction}>
          ...
          {isEditing && (
            <button type="button" className="btn-cancel" onClick={() => { setIsEditing(null); setFormData({ studentId: "", courseId: "", score: "" }); }}>
              Cancel
            </button>
          )}
        </form>
      ...
      <div className="table-wrapper">
        <table>
          <thead>
            <tr><th>Student</th><th>Course</th><th>Score</th><th>Grade</th><th>Actions</th></tr>
          </thead>
          <tbody>
            {grades.map((g) => (
              <tr key={g.id}>
